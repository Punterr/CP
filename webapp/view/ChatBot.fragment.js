sap.ui.jsfragment("com.airbus.unc.main.CP.view.ChatBot", {
    ...
    createContent: function() {
        ...
        var oTextArea=new sap.m.Input("chat",{placeholder:"Write a reply",autofocus:"autofocus",valueLiveUpdate:false, change:"onChange"}).addStyleClass("input middle");
